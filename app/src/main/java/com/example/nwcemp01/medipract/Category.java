   ...
   */
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  mToolbars = (Toolbar) findViewById(R.id.tb_header_view);
        ...
        boolean network = Function.isNetworkAvailable(Category.this);
        if (network == false) {
            Function.showToast(Category.this, "Please activate the network", Toast.LENGTH_LONG);
        } else {
            oCustomProgressDialog = CustomProgressDialog.getInstance();
            oCustomProgressDialog.show(Category.this, "", "please wait");
/*
...
*/
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Category.this, Booking.class);
